    ...
    return MultiProvider(
      ...
      child: IgnorePointer(
        ...
        child: Scaffold(
          ...
          body: Stack(
            children: [
              // Fill the screen with the game widget
              Positioned.fill(
                child: GameWidget(),
              ),
              // Overlay UI elements on top of the game
              Column(
                children: [
                  Align(
                  ...
                  // Other widgets can be added here if needed, such as score display
                  Spacer(), // Use Spacer at the end to push everything up
                ],
              ),
