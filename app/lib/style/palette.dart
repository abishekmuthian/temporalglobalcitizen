...
class Palette {
  ...
  Color get backgroundMain => const Color(0xfffaf6ea);
  Color get backgroundLevelSelection => const Color(0xffdefee8);
  Color get backgroundPlaySession => const Color(0xfffaf6e8);
  Color get background4 => const Color(0xffffd7ff);
  Color get backgroundSettings => const Color(0xffbfc8e3);
  Color get trueWhite => const Color(0xffffffff);
  Color get brightRed => const Color(0xffff4c41);
  Color get brightYellow => const Color(0xffffff81);
  Color get terminalGreen => const Color(0xff2bd33c);
}
